    ...
    <div className="min-h-screen bg-[#F8FAFC] dark:bg-slate-950 font-cairo text-right flex flex-col transition-colors duration-500" dir="rtl">
      ...
      <main className="flex-1 py-20 px-4">
        <div className="container max-w-4xl mx-auto">
           {/* Header Area */}
            <div className="text-center mb-16 relative">
               ...
               <motion.div
                 ...
                 className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-indigo-50 dark:bg-indigo-900/30 text-indigo-600 dark:text-indigo-400 text-sm font-black mb-6 relative z-10"
               >
                  <ShieldCheck className="w-4 h-4" />
                  السياسات القانونية
               </motion.div>
               <h1 className="text-4xl md:text-5xl font-black text-gray-900 dark:text-white mb-6 relative z-10">الشروط <span className="text-indigo-600 dark:text-indigo-400">والأحكام</span></h1>
           ...
           {/* Content Sections */}
           <div className="bg-white dark:bg-slate-900 rounded-[3rem] p-8 md:p-16 shadow-2xl shadow-indigo-100/10 dark:shadow-none border border-gray-100 dark:border-slate-800 space-y-12">
              ...
              {/* Legal Note Box */}
              <div className="bg-orange-50/50 dark:bg-orange-900/20 rounded-3xl p-8 border border-orange-100 dark:border-orange-900/30 relative overflow-hidden">
                 <div className="absolute top-0 right-0 w-32 h-32 bg-orange-100/50 dark:bg-orange-900/30 rounded-full translate-x-12 -translate-y-12 blur-3xl" />
                 <div className="relative z-10">
                    <div className="flex items-center gap-3 mb-4">
                       <AlertCircle className="w-6 h-6 text-orange-600 dark:text-orange-400" />
                       <h3 className="font-black text-gray-900 dark:text-white text-xl">تنبيه قانوني هام</h3>
                    </div>
                    <p className="text-orange-900/70 dark:text-orange-200/70 font-bold leading-relaxed">
              ...
              <div className="pt-12 border-t border-gray-100 dark:border-slate-800 flex flex-col sm:flex-row items-center justify-between gap-8">
                 <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-500 dark:text-slate-400 font-black">أنا أوافق على كافة الشروط المذكورة</span>
                 </div>
                 <Button asChild className="h-14 px-8 rounded-2xl bg-indigo-600 hover:bg-indigo-700 text-white font-black text-lg gap-2">
                    <Link to="/">
                       متابعة الاستخدام
