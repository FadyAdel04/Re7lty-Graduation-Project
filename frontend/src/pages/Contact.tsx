...
const Contact = () => {
  ...
  return (
    <div 
      className="min-h-screen font-cairo text-right flex flex-col transition-colors duration-700 bg-background"
      dir="rtl"
    >
      <Header />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
            ...
            <div className="lg:col-span-4 space-y-8">
               ...
               >
                  ...
                  <h1 className="text-4xl font-black text-foreground mb-6">دعنا ننتقل <br /> بالتواصل <span className="text-indigo-600">لآفاق جديدة</span></h1>
               ...
               <div className="space-y-4">
                  {[
                    ...
                    >
                       <Card className="border-0 shadow-sm rounded-3xl overflow-hidden hover:shadow-md transition-all group bg-card">
                          <CardContent className="p-6 flex items-center gap-4">
                             ...
                             <div>
                                <h4 className="text-muted-foreground text-xs font-black uppercase mb-1">{item.label}</h4>
            ...
            >
               <Card className="border-0 shadow-2xl rounded-[3rem] bg-card overflow-hidden">
                  <CardContent className="p-8 md:p-16">
                     <form onSubmit={handleSubmit} className="space-y-8">
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                           <div className="space-y-3">
                              <Label htmlFor="name" className="text-foreground font-black mr-2">الاسم الكامل</Label>
                              <Input
                                 id="name"
                                 value={formData.name}
                                 onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                                 placeholder="أحمد محمد..."
                                 className="h-14 rounded-2xl bg-background border border-border focus-visible:ring-indigo-600 font-bold px-6"
                                 required
                              />
                           </div>
                           <div className="space-y-3">
                              <Label htmlFor="email" className="text-foreground font-black mr-2">البريد الإلكتروني</Label>
                              <Input
                                 id="email"
                                 type="email"
                                 ...
                                 className="h-14 rounded-2xl bg-background border border-border focus-visible:ring-indigo-600 font-bold px-6 uppercase tracking-wider"
                                 required
                              />
                           </div>
                        </div>
                        ...
                        <div className="space-y-3">
                           <Label htmlFor="subject" className="text-foreground font-black mr-2">موضوع الرسالة</Label>
                           <Input
                              id="subject"
                        ...
                        <div className="space-y-3">
                           <Label htmlFor="message" className="text-foreground font-black mr-2">نص الرسالة</Label>
                           <Textarea
                              id="message"
                              value={formData.message}
                              onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                              placeholder="اكتب تفاصيل استفسارك هنا..."
                              className="min-h-[200px] rounded-3xl bg-background border border-border focus-visible:ring-indigo-600 font-bold p-6 leading-relaxed"
                              required
                           />
                        </div>
                        ...
                        <div className="flex items-center gap-2 text-muted-foreground text-xs font-bold pt-4 border-t border-border">
